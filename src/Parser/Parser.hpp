...
namespace RayTracer::Parser
{
    class Parser
    {
        public:
            ...
            void CreateCamera(RayTracer::Scene::Scene &scene, RayTracer::Plugin::PluginManager &pluginManager);
            void CreatePrimitive(RayTracer::Scene::Scene &scene, RayTracer::Plugin::PluginManager &pluginManager);
            void CreateLight(RayTracer::Scene::Scene &scene, RayTracer::Plugin::PluginManager &pluginManager);
